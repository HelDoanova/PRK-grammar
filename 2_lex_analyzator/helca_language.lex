...
[0-9]+ {int_values=process_pattern(values,"Integer number detected.");}
b[0-1]+ {bin_values=process_pattern(values,"Binary number detected.");}
"0x"[0-9A-F]+ {hexa_values=process_pattern(hexa_values,"Hexa number detected.");}
